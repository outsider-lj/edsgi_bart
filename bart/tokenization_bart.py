...
from modeling.file_utils import cached_path
...
from modeling.tokenization_utils_base import  BatchEncoding

logger = logging.getLogger(__name__)

PRETRAINED_VOCAB_ARCHIVE_MAP = {
    # 'gpt2': "https://s3.amazonaws.com/models.huggingface.co/bert/gpt2-vocab.json",
    # 'bart-large': "https://s3.amazonaws.com/models.huggingface.co/bert/roberta-large-vocab.json",
}
PRETRAINED_MERGES_ARCHIVE_MAP = {
    # 'gpt2': "https://s3.amazonaws.com/models.huggingface.co/bert/gpt2-merges.txt",
    # 'bart-large': "https://s3.amazonaws.com/models.huggingface.co/bert/roberta-large-merges.txt",
}
...
class  BartTokenizer(object):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, cache_dir=None, *inputs, **kwargs):
        """
        Instantiate a BartTokenizer from a pre-trained model file.
    ...
    def tokenize(self, text):
        """ Tokenize a string. """
        bpe_tokens = []
        if text in self.special_tokens.keys():
            bpe_tokens=[text]
        else:
